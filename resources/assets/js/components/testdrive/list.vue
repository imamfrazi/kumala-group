  ...
  <div>
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">REPORT DATA TEST DRIVE</h1>
            </div>
            <!-- /.col -->
          </div>
          <!-- /.row -->
...
export default {
  ...
  methods: {
    load() {
      ...
      axios.get("api/drive").then(({ data }) => (this.drives = data));
    },
    deletetest(id) {
      swal({
        title: "Are you sure?",
    ...
    getResults(page = 1) {
      axios.get("api/test?page=" + page).then(response => {
        this.tests = response.data;
      });
    },
    getResult(page = 1) {
      axios.get("api/drive?page=" + page).then(response => {
