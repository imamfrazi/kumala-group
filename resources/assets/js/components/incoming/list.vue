  ...
  <div>
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">REPORT DATA INCOMING</h1>
            </div>
            <!-- /.col -->
          </div>
          <!-- /.row -->
...
export default {
  ...
  methods: {
    load() {
      axios.get("api/come").then(({ data }) => (this.tests = data));
      axios.get("api/coming").then(({ data }) => (this.drives = data));
    },
    deletetest(id) {
      swal({
        title: "Are you sure?",
    ...
    getResults(page = 1) {
      axios.get("api/come?page=" + page).then(response => {
        this.tests = response.data;
      });
    },
    getResult(page = 1) {
      axios.get("api/coming?page=" + page).then(response => {
