														...
														<div id="myTabContent" class="tab-content">
															...
															<div class="tab-pane fade" id="dropdown1">
																...
																<div class="col_half card">
																	<div class="card-header">Jalan A.Mappanyuki</div>
																	<div class="card-body">
																		<img src="images/otomotif/1.png" width="150px" alt="">
																		<!-- <h4 class="card-title">Card Title</h4> -->
																		<p class="card-text"> temporibus soluta accusamus eum accusantium incidunt eius quisquam suscipit inventore neque. Distinctio, impedit.</p>
																	</div>
																</div>
