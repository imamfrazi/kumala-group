					...
					<div class="container clear-bottommargin clearfix">
						...
						<div class="col_one_fourth nobottommargin">
							<div class="ipost clearfix" data-animate="fadeIn">
								...
								<a href="detail_berita.html"><img style="height: 180px" class="image_fade" src="{{asset('img/berita/'.$data['gambar'])}}" alt="Image"></a>
								</div>
								<div class="entry-title">
								<h3><a href="blog-single.html">{{$data->judul}}</a></h3>
								</div>
								...
								<p>{{substr($data->deskripsi,0, 60)}}...<a href="{{route('db')}}">Lebih lanjut. </a></p>
								</div>
							</div>
						</div>
						@endforeach
