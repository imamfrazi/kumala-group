	...
	<div id="wrapper" class="clearfix">
				...
				<div class="container clearfix">
					...
					<nav id="primary-menu">
						...
						<ul>
							...
							<li class=" current"><a href="#"><div>Tentang Kami</div></a>
								<ul>
						...
						<li class="mega-menu"><a href="{{route('berita')}}"><div>Berita</div></a></li>
							...
							<li class="mega-menu"><a href="kontak.html"><div>Kontak</div></a></li>
						</ul>
		...
		<section id="content">
			...
			<!-- <div class="heading-block topmargin notopborder center">
				<h3 data-animate="fadeInDown">Hubungi Kami </h3>
			</div> -->
                ...
                <div class="col">
						...
						<div class="tabs tabs-bb clearfix" id="tab-9">
							...
							<ul class="tab-nav clearfix">
								<li><a href="#tabs-33"><i class="icon-home2 norightmargin"></i>Visi & Misi</a></li>
								<li><a href="#tabs-34">Sejarah</a></li>
